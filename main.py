...
from tkinter import ttk  # from tkinter import ttk module
...
# defining the function that will help us to add tasks in the list.
def add_task():
    ...
    if len(task_string) == 0:
        ...
        # using method to execute a SQL statement.
...
def list_update():
    ...
    for task in tasks:
        # insert the tasks in the list box.
...
if __name__ == '__main__':
    ...
    guiWindow.configure(bg="Pale Violet Red")
...
header_frame = tk.Frame(guiWindow, bg="Pale Violet Red")
functions_frame = tk.Frame(guiWindow, bg="Pale Violet Red")
listbox_frame = tk.Frame(guiWindow, bg="Pale Violet Red")
